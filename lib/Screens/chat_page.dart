  ...
  getDocumentID() async {
    ...
    try {
      ...
      for (int i = 0; i < documentIds.length; i++) {
        ...
        // Check if the currentString contains the currentUserId
        if (currentString.contains(currentUserId)) {
          // If it does, remove the currentUserId from the currentString
          ...
          used.add(modifiedString);
          print("Used: $used");
          print("Current User $currentUserId");
          nouser = false;
        } else {
          unuseddocumentIds.add(documentIds[i]);
          print("Unused IDs1: $unuseddocumentIds");
          // /nouser = true;
        }
      }
    } catch (e) {
