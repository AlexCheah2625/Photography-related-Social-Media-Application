...
import 'package:practice/Screens/iso_search.dart';
...
class Shuttle_Search extends StatefulWidget {
  const Shuttle_Search({super.key});

  @override
  State<Shuttle_Search> createState() => _Shuttle_SearchState();
}

class _Shuttle_SearchState extends State<Shuttle_Search> {
            ...
            child: SizedBox(
              ...
              child: TextFormField(
                decoration: InputDecoration(
                  labelText: 'Search Shuttle Speed',
        ...
        body: showPosts
            ? FutureBuilder(
                future: FirebaseFirestore.instance
                    .collection('posts')
                    .where('shuttlespeed', isEqualTo: searchPosts.text)
                    .get(),
