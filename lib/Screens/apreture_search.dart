...
class Aperture_Search extends StatefulWidget {
  const Aperture_Search({super.key});

  @override
  State<Aperture_Search> createState() => _Aperture_SearchState();
}

class _Aperture_SearchState extends State<Aperture_Search> {
        ...
        body:  showPosts
            ? FutureBuilder(
                future: FirebaseFirestore.instance
                    .collection('posts')
                    .where('apreture', isEqualTo: searchPosts.text)
                    .get(),
